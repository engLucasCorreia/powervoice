...
| H-86 | EQ mouse gestures vs SPEC-015 §2.6.4: double-click should reset a band (it toggles), and the wheel should step HP/LP slope (H-84's open question) | S | in progress |
