...
| H-120 | Found by H-119: `engine/tests/punch_crash.rs` and `recording.rs` read a crash child's output with no timeout — the same hang class; give them the H-119 deadline | S | todo |
