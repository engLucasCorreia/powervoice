...
| ID | Title | Tier | Deps | Status |
|---|---|---|---|---|
| S3-01 | Rack panel + generic parameter UI end-to-end | S | S1-01, H-01 | in-progress |
| S3-02 | Dynamics (compressor + limiter) + Noise Gate modules | O | T-103, H-01 | done |
| S3-03 | Parametric EQ module (library part, lean SPEC-015) | O | T-103, H-01 | in-progress |
