...
| H-71 | Progressive peaks during import (H-60/H-20, SPEC-005 §2.3 + SPEC-006 AC-13): VXPK's PARTIAL bit and the decoder exist but nothing emits them — stream partial peaks so a long import draws progressively instead of appearing at the end | S | in progress |
