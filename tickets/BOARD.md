...
| S3-07 | EQ graph panel (ResponseCurve, draggable nodes) | S | S3-01, S3-03 | in progress |
...
| H-10 | Recording follow-ups from the H-05 review: document stuck after a failed take commit; input dropout detection + markers; disk-space floor / remaining time; clip lamp reset at take start; live-peaks memory cap; nr_capture test temp-dir leak | S | todo |
