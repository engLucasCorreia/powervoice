...
| H-24 | OWNER-REPORTED TOP PRIORITY: resizable layout (splitters, persisted), analyzer growth fix, correct scales/grids/units (analyzer Hz/dB, spectral ruler, waveform dBFS + adaptive time ruler, EQ axes), no overlaps | S | in progress |
| H-25 | OWNER REQUEST: big-tech-quality visual design — design audit + design system + tokens + component kit (phase 1), applied across the app after H-24 (phase 2); ui-ux-designer agent | O | in progress (phase 1) |
...
| T-802 | Sandbox process, watchdog, proxy module | W2 | O | T-801 | in progress |
