...
| H-119 | `crates/project/tests/crash.rs`'s ac9 test reads a child's output with no timeout and has hung twice under load, killing the whole gate at its 50-minute ceiling — every blocking wait needs a deadline | S | todo |
