...
| H-126 | Documentation sweep before the pause: user guide, FAQ, Help Centre and tour must describe v0.4.1 (Explain export, Inspector legend, EQ menu, meter speed, live waveform, chmod +x) | S | done |
| H-127 | Retake the four README screenshots — they show the pre-v0.4.1 meters, rack, EQ and selection (found by H-126) | S | todo |
