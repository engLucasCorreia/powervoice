...
| H-49 | Packaging (T-901): deb Recommends `libsuil-0-0` (LV2 plugin windows) and libX11 where needed; user-guide note on plugin windows (Linux X11/XWayland, Windows untested, macOS not yet) | H | in progress |
