# S3-03 — Parametric EQ module + EQ graph (Slice 3)

- **Tier:** Opus (one Opus review of the DSP/RT part, blocking findings only)
- **Depends on:** S3-01 (rack panel + generic UI), H-01 (rack fix)
