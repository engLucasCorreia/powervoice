...
export async function runPreviewScene(options: PreviewOptions, menu: string | null): Promise<void> {
  ...
  const wantsDocument =
    ...
    (dialog !== null &&
      !["about", "preferences", "recovery", "new-recording", "audio-devices", "channel-choice", "tour-offer", "help"].includes(
        dialog,
      ));
  ...
  switch (dialog) {
    case "about":
      ...
      break;
    case "help": {
      // H-107: `&dialog=help[&help=<doc>:<section>]` (default `user-guide:plugins`, the
      // screenshot-worthy topic) — a doc/section as generated by `scripts/help/generate.py`.
      const params = new URLSearchParams(window.location.search);
      const [helpDoc, helpSection] = (params.get("help") ?? "user-guide:plugins").split(":");
      openHelpCentre(helpDoc && helpSection ? { doc: helpDoc, section: helpSection } : undefined);
      break;
    }
    case "preferences":
      openPreferences();
